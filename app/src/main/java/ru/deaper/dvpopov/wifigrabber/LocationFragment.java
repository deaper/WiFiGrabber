...
/**
 * Created by dvpopov on 18.11.2014.
 */
public class LocationFragment extends FragmentActivity {
    ...
    private void setUpMap() {
        ...
        Toast toast = Toast.makeText(context, provider, duration);
        toast.show();
  ...
  */
    ...
    private class LocationUpdateListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            ...
            // Zoom in the Google Map
            mMap.animateCamera(CameraUpdateFactory.zoomTo(14));
            //mMap.addMarker(new MarkerOptions().position(new LatLng(latitude, longitude)).title("You are here!").snippet("Consider yoursel
        }
